        ...
        <div className="grid lg:grid-cols-2 gap-10 md:gap-12 items-start">
          ...
          <div className="order-2 text-gray-700 leading-relaxed mt-6 lg:mt-2">
            ...
            >
              ...
              <span className="font-semibold text-[#11689B]">MyBhoomee</span> with a simple belief: every family deserves a home built on trust. He personally visits every project site to ensure quality standards are never compromised. His vision is to make plotted development accessible, legal, and future-ready for middle-class India. Under his leadership, MyBhumi has delivered over 50 projects with 100% clear titles and approvals. He insists on complete transparency — from soil testing reports to bank loan tie-ups. Customers feel like talking to a family member, not a developer. He introduced weekend site visits and live project tracking apps — first in the region. His mantra: “We don’t sell plots. We hand over peace of mind in the form of land.” MyBhumi is not just his company — it's his promise to India’s future.
            </p>
          </div>
